...
const FaceFollower = (props) => {
  ...
  const objRef = useRef()
  const gltf = useGLTF('/models/luffy_hat.glb'); // put your model in public/models/
  ...
  return (
    <object3D ref={objRef}>
      <primitive
        object={gltf.scene}
        position={[0, 0.8, 0]} // adjust Y for top of head
        scale={[1, 1, 1]}      // scale your model if needed
      />
    </object3D>
  )
}
