...
export default function DressesPage() {
  const categoryName = getCategoryNameFromRoute("dresses");
  const categoryId = getCategoryIdFromRoute("dresses");
  ...
  return (
    <main className="min-h-screen p-6 bg-gradient-to-b from-blue-50 to-white">
      ...
      <TopSoldSection categoryRoute="dresses" categoryId={categoryId} />
      <AllProductsSection categoryRoute="dresses" categoryId={categoryId} />
    </main>
  )
}
