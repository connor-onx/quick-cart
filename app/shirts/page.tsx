...
export default function ShirtsPage() {
  const categoryName = getCategoryNameFromRoute("shirts");
  ...
  return (
    <main className="min-h-screen p-6 bg-gradient-to-b from-blue-50 to-white">
      ...
      <TopSoldSection categoryRoute="shirts" categoryId={categoryId} />
      <AllProductsSection categoryRoute="shirts" categoryId={categoryId} />
    </main>
  )
}
